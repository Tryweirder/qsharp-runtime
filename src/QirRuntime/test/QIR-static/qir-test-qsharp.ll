...
@1 = internal constant [20 x i8] c"Pauli value: PauliI\00"
@2 = internal constant [14 x i8] c"Pauli value: \00"
@3 = internal constant [7 x i8] c"PauliX\00"
@4 = internal constant [7 x i8] c"PauliY\00"
@5 = internal constant [7 x i8] c"PauliZ\00"
...
define i64 @Microsoft__Quantum__Testing__QIR__Math__DrawRandomIntTest__body(i64 %min, i64 %max) {
entry:
...
entry:
  %d = call double @Microsoft__Quantum__Math__E__body()
  %0 = call double @__quantum__qis__log__body(double %d)
...
continue__1:                                      ; preds = %entry
  ...
  %d__1 = fmul double %2, %3
  %4 = call double @__quantum__qis__log__body(double %d__1)
...
continue__2:                                      ; preds = %continue__1
  %d__3 = call double @__quantum__qis__log__body(double 0.000000e+00)
  %6 = call i1 @__quantum__qis__isnegativeinfinity__body(double %d__3)
  %7 = xor i1 %6, true
...
continue__3:                                      ; preds = %continue__2
  %d__5 = call double @__quantum__qis__log__body(double -5.000000e+00)
  %8 = call i1 @__quantum__qis__isnan__body(double %d__5)
  %9 = xor i1 %8, true
...
continue__4:                                      ; preds = %continue__3
  %d__6 = call double @__quantum__qis__nan__body()
  %d__7 = call double @__quantum__qis__log__body(double %d__6)
  %10 = call i1 @__quantum__qis__isnan__body(double %d__7)
  %11 = xor i1 %10, true
...
continue__5:                                      ; preds = %continue__4
  %d__8 = call double @__quantum__qis__infinity__body()
  %d__9 = call double @__quantum__qis__log__body(double %d__8)
  %12 = call i1 @__quantum__qis__isinf__body(double %d__9)
  %13 = xor i1 %12, true
...
define double @Microsoft__Quantum__Intrinsic__ArcTan2__body(double %y, double %x) {
entry:
...
define double @Microsoft__Quantum__Intrinsic__Log__body(double %d) {
entry:
  %0 = call double @__quantum__qis__log__body(double %d)
  ret double %0
}
...
then0__1:                                         ; preds = %exit__1
  ...
  %res8 = call i64 @Microsoft__Quantum__Testing__QIR__Math__DrawRandomIntTest__body(i64 0, i64 1)
  %21 = call %String* @__quantum__rt__string_create(i32 4, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @0, i32 0, i32 0))
  call void @Microsoft__Quantum__Testing__QIR__Out__MessageTest__body(%String* %21)
...
entry:
  %0 = call %String* @__quantum__rt__string_create(i32 19, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @1, i32 0, i32 0))
  %1 = call %String* @__quantum__rt__string_create(i32 13, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @2, i32 0, i32 0))
  %2 = load i2, i2* @PauliI
...
continue__1:                                      ; preds = %entry
  %7 = call %String* @__quantum__rt__string_create(i32 6, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @3, i32 0, i32 0))
  %8 = load i2, i2* @PauliX
...
continue__2:                                      ; preds = %continue__1
  %12 = call %String* @__quantum__rt__string_create(i32 6, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @4, i32 0, i32 0))
...
continue__3:                                      ; preds = %continue__2
  %17 = call %String* @__quantum__rt__string_create(i32 6, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @5, i32 0, i32 0))
